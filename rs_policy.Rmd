...
subtitle: "*Jakarta, the fastest sinking city in the world*"  
author: 
...
style_duo_accent(
  ...
  text_font_google   = google_font("Lato", "400", "300i"),
...
Reference:
[Estimation, modeling, and prediction of land subsidence using Sentinel-1 time series in Tehran-Shahriar plain: A machine learning-based investigation](https://www.sciencedirect.com/science/article/pii/S2352938521002275)
]
...
.right-column[
1. **UN SDGs 6 Clean Water and Sanitation**

   This ihfjkahfjkadhfkjdah

2. **UN SDGs 11 Sustainable Cities and Communities**

   Jakarta is one of the largest metropolitan city in the world with population around .. million people. The land subsidence can put the city and it's citizens in high risk area. The solution to this problem should be executed in the near future to keep the city and communities sustain.

3. **UN SDGs 13 Climate Action**
